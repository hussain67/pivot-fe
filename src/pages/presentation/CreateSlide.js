						...
						>
							...
							<div className="form__row">
								...
								<textarea
									type="text"
									name="slideBody"
									className="form__input form__body"
									onChange={handleChange}
									value={slide.slideBody}
								/>
							</div>
							<div className="form__row">
								<label
							...
							<button
								type="submit"
								className="btn btn__block btn-create-slide"
							>
								Submit
							</button>
						</form>
					...
					{slides?.length > 0 &&
						slides.map(slide => {
							return (
								<li key={slide._id}>
									<Link
										to={`/presentation/${id}/slide-view/${slide._id}`}
										key={slide._id}
									>
										{slide.slideTitle}
									</Link>
